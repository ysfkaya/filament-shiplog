...
`;var O={megaphone:"M10.34 15.84c-.688-.06-1.386-.09-2.09-.09H7.5a4.5 4.5 0 1 1 0-9h.75c.704 0 1.402-.03 2.09-.09m0 9.18c.253.962.584 1.892.985 2.783.247.55.06 1.21-.463 1.511l-.657.38c-.551.318-1.26.117-1.527-.461a20.845 20.845 0 0 1-1.44-4.282m3.102.069a18.03 18.03 0 0 1-.59-4.59c0-1.586.205-3.124.59-4.59m0 9.18a23.848 23.848 0 0 1 8.835 2.535M10.34 6.66a23.847 23.847 0 0 0 8.835-2.535m0 0A23.74 23.74 0 0 0 18.795 3m.38 1.125a23.91 23.91 0 0 1 1.014 5.395m-1.014 8.855c-.118.38-.245.754-.38 1.125m.38-1.125a23.91 23.91 0 0 0 1.014-5.395m0-3.46c.495.413.811 1.035.811 1.73s-.316 1.317-.811 1.73m0-3.46a24.347 24.347 0 0 1 0 3.46",close:"M6 18 18 6M6 6l12 12"},j=(s,a)=>`<svg class="${a}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="${s}"/></svg>`,d=s=>String(s??"").replace(/[&<>"']/g,a=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[a]),l,m,b,f,u,v,h,r,x,L,F,Y,k,A,$,y,I,_,z,M,N,P,B,g,K,q,w=class extends HTMLElement{constructor(){super(...arguments);n(this,r);n(this,l);n(this,m,!1);n(this,b,"idle");n(this,f,[]);n(this,u,null);n(this,v,null);n(this,h,null);n(this,k,e=>{e.key==="Escape"&&t(this,m)&&(e.stopPropagation(),this.close())});n(this,A,()=>{let e=t(this,r,L),i=e.scrollHeight-e.clientHeight;t(this,l).host.style.setProperty("--sl-scrolled",`${i>0?Math.min(100,e.scrollTop/i*100):0}%`)});n(this,_,(e,i)=>{let p=(e.changes||[]).map(S=>`<span class="sl-badge" style="--accent:${d(S.accent)}">${d(S.label)} <b>${d(S.count)}</b></span>`).join("");return`<li class="sl-release" style="--i:${i}"${e.yanked?" data-yanked":""}>
        ...
        </li>`});n(this,g,()=>{let e=document.documentElement,i=e.getAttribute("data-theme"),p=i?i==="dark":e.classList.contains("dark")||!!t(this,h)?.matches;this.dataset.theme=p?"dark":"light"})}connectedCallback(){document.addEventListener("keydown",t(this,k)),!t(this,l)&&(c(this,l,this.attachShadow({mode:"open"})),t(this,l).innerHTML=o(this,r,F).call(this),o(this,r,Y).call(this),o(this,r,B).call(this),o(this,r,z).call(this),this.mode==="inline"&&o(this,r,$).call(this))}disconnectedCallback(){t(this,v)?.disconnect(),t(this,h)?.removeEventListener("change",t(this,g)),document.removeEventListener("keydown",t(this,k)),o(this,r,q).call(this)}attributeChangedCallback(){t(this,l)&&o(this,r,z).call(this)}get mode(){return this.getAttribute("mode")==="inline"?"inline":"fab"}get src(){return this.getAttribute("src")||""}get isOpen(){return t(this,m)}open(){t(this,m)||this.mode==="inline"||(c(this,m,!0),c(this,u,document.activeElement),t(this,r,x).setAttribute("data-open",""),t(this,r,x).removeAttribute("aria-hidden"),o(this,r,K).call(this),o(this,r,P).call(this),o(this,r,z).call(this),o(this,r,$).call(this),requestAnimationFrame(()=>t(this,l).querySelector(".sl-close")?.focus()),this.dispatchEvent(new CustomEvent("shiplog:open",{bubbles:!0,composed:!0})))}close(){t(this,m)&&(c(this,m,!1),t(this,r,x).removeAttribute("data-open"),t(this,r,x).setAttribute("aria-hidden","true"),o(this,r,q).call(this),t(this,u)instanceof HTMLElement&&t(this,u).focus(),this.dispatchEvent(new CustomEvent("shiplog:close",{bubbles:!0,composed:!0})))}toggle(){t(this,m)?this.close():this.open()}refresh(){return c(this,b,"idle"),o(this,r,$).call(this)}};l=new WeakMap,m=new WeakMap,b=new WeakMap,f=new WeakMap,u=new WeakMap,v=new WeakMap,h=new WeakMap,r=new WeakSet,x=function(){return t(this,l).querySelector(".sl-overlay")},L=function(){return t(this,l).querySelector(".sl-scroll")},F=function(){let e=this.getAttribute("label")||"What\u2019s new",i=this.getAttribute("heading")||e,p=this.getAttribute("subheading")||"";return`<style>${H}</style>
            ${this.mode==="inline"?"":`
            ...
            </div>`},Y=function(){t(this,l).querySelector(".sl-fab")?.addEventListener("click",()=>this.toggle()),t(this,l).querySelector(".sl-close")?.addEventListener("click",()=>this.close()),t(this,l).querySelector(".sl-backdrop")?.addEventListener("click",()=>this.close()),t(this,r,L)?.addEventListener("scroll",t(this,A),{passive:!0})},k=new WeakMap,A=new WeakMap,$=async function(){if(!(t(this,b)==="loading"||t(this,b)==="loaded"||!this.src)){c(this,b,"loading"),o(this,r,y).call(this,'<div class="sl-state"><span class="sl-spinner"></span></div>');try{let e=await fetch(this.src,{headers:{Accept:"application/json"},credentials:"same-origin"});if(!e.ok)throw new Error(`HTTP ${e.status}`);let i=await e.json();c(this,f,Array.isArray(i.releases)?i.releases:[]),c(this,b,"loaded"),o(this,r,I).call(this)}catch{c(this,b,"idle"),o(this,r,y).call(this,`<div class="sl-state">${d(this.getAttribute("error-text")||"The changelog could not be loaded.")}</div>`)}}},y=function(e){t(this,l).querySelector(".sl-content").innerHTML=e},I=function(){if(t(this,f).length===0){o(this,r,y).call(this,`<div class="sl-state">${d(this.getAttribute("empty-text")||"Nothing shipped yet.")}</div>`);return}o(this,r,y).call(this,`<ol class="sl-timeline">${t(this,f).map(t(this,_)).join("")}</ol>`)},_=new WeakMap,z=function(){let e=t(this,l).querySelector(".sl-fab");e&&(e.dataset.position=this.getAttribute("position")||"bottom-right",e.querySelector(".sl-fab__label").textContent=this.getAttribute("label")||"What\u2019s new",e.querySelector(".sl-fab__dot")?.remove(),o(this,r,N).call(this)&&e.insertAdjacentHTML("beforeend",'<span class="sl-fab__dot" aria-hidden="true"></span>'))},M=function(){return`shiplog:seen:${this.getAttribute("storage-key")||"default"}`},N=function(){let e=this.getAttribute("latest");if(!e)return!1;try{return window.localStorage.getItem(o(this,r,M).call(this))!==e}catch{return!1}},P=function(){let e=this.getAttribute("latest");if(e)try{window.localStorage.setItem(o(this,r,M).call(this),e)}catch{}},B=function(){if(this.hasAttribute("theme")){this.dataset.theme=this.getAttribute("theme");return}c(this,h,window.matchMedia("(prefers-color-scheme: dark)")),t(this,h).addEventListener("change",t(this,g)),c(this,v,new MutationObserver(t(this,g))),t(this,v).observe(document.documentElement,{attributes:!0,attributeFilter:["class","data-theme"]}),t(this,g).call(this)},g=new WeakMap,K=function(){this.dataset.previousOverflow=document.body.style.overflow,document.body.style.overflow="hidden"},q=function(){"previousOverflow"in this.dataset&&(document.body.style.overflow=this.dataset.previousOverflow,delete this.dataset.previousOverflow)},C(w,"observedAttributes",["position","label","latest"]);customElements.get("ship-log")||customElements.define("ship-log",w);window.ShipLog={element:()=>document.querySelector("ship-log"),open:()=>window.ShipLog.element()?.open(),close:()=>window.ShipLog.element()?.close(),toggle:()=>window.ShipLog.element()?.toggle(),refresh:()=>window.ShipLog.element()?.refresh()};var J=w;export{J as default};
